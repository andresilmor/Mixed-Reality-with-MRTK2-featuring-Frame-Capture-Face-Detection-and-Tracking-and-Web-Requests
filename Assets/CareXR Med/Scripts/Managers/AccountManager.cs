...
public static class AccountManager {
    ...
    public static bool LoginQR() {
        ...
        WebSocket authChannel = APIManager.CreateWebSocketConnection(APIManager.QRAuth, (WebSocket ws, string response) => {
            ...
            APIManager.GetWebSocket(APIManager.QRAuth).Close();

        }, null, (WebSocket ws) => {
            Debug.Log("A ON OPEN CALLED");

            APIManager.CreateWebSocketConnection(APIManager.QRDecode, null, null, (WebSocket ws) => {
                Debug.Log("B ON OPEN CALLED");

                QRCodeReaderManager.DetectQRCodes(DetectionMode.OneShot, (List<QRCodeDecodeReply.Detection> qrCodes) => {
                Debug.Log("C ON OPEN CALLED");
