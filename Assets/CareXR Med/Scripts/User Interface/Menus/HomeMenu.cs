...
public class HomeMenu : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _QRCodeBtn.OnClick.AddListener(() => {
            ...
            UIManager.Instance.QRCodeMenu.gameObject.transform.LookAt(Controller.CameraMain.transform.position);
        ...
        _faceReconBtn.OnClick.AddListener(() => {
            ...
            UIManager.Instance.FaceReconMenu.gameObject.transform.LookAt(Controller.CameraMain.transform.position);
        ...
        _debugBtn.OnClick.AddListener(() => {
            ...
            UIManager.Instance.DebugMenu.gameObject.transform.LookAt(Controller.CameraMain.transform.position);
